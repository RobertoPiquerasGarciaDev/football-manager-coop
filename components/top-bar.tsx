      ...
      <div className="flex items-center justify-between px-4 py-3">
        <div className="flex items-center gap-3">
          <div className="relative">
            <div className="w-10 h-10 rounded-xl bg-gradient-to-br from-[var(--amber)] to-[#D4961A] flex items-center justify-center shadow-[0_0_20px_var(--amber-glow)]">
            ...
            <div className="absolute -bottom-0.5 -right-0.5 w-3 h-3 rounded-full bg-[var(--success-green)] border-2 border-card animate-pulse-dot" />
          </div>
          <div>
        ...
        <div className="flex items-center gap-3">
          <div className="flex items-center gap-1.5 px-3 py-1.5 rounded-lg bg-[var(--stats-blue-glow)] border border-[var(--stats-blue)]/20">
