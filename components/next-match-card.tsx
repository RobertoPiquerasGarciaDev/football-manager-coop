...
export function NextMatchCard() {
  const { getNextUserMatch, getUserClub } = useGame()
  ...
  return (
    <div className="mx-4 mt-4" aria-label="Next match">
      <div className="relative overflow-hidden rounded-2xl bg-gradient-to-br from-card via-card to-secondary/50 border border-border/50">
        <div
        ...
        <div className="relative flex items-center justify-between px-4 pt-4 pb-2">
          <div className="flex items-center gap-2">
            <div className="w-1.5 h-1.5 rounded-full bg-[var(--success-green)] animate-pulse-dot" />
